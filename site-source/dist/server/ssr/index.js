...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-BbHFbe-c.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"25ccd5d58365": async () => {
		const m = await import("./assets/NewsExplorer-DNLRSD5E.js");
		return { get "NewsExplorer"() {
			return m["NewsExplorer"];
		} };
	},
	"326fe58ccdc4": async () => {
		const m = await import("./assets/SiteHeader-CPmVmXK7.js");
		return { get "SiteHeader"() {
			return m["SiteHeader"];
		} };
	},
	"3f9c1efe2e31": async () => {
		const m = await import("./assets/CookieNotice-BlH3rWIX.js");
		return { get "CookieNotice"() {
			return m["CookieNotice"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DqyAanGs.js");
		return {
			get "ErrorBoundary"() {
	...
	"6434b5bd39c7": async () => {
		const m = await import("./assets/GuideExplorer-C9FNbOEh.js");
		return { get "GuideExplorer"() {
			return m["GuideExplorer"];
		} };
	},
	"8c0f216c4604": async () => {
	...
	"8f2e34e5281c": async () => {
		const m = await import("./assets/AIInfluencerCatalog-IiqVzkFn.js");
		return { get "AIInfluencerCatalog"() {
			return m["AIInfluencerCatalog"];
		} };
	},
	"9d26a3eddb3a": async () => {
		const m = await import("./assets/Analytics-D7fbGD3O.js");
		return { get "Analytics"() {
			return m["Analytics"];
		} };
	},
	"a9bbde40cf2d": async () => {
		const m = await import("./assets/error-cvOytg4E.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"bd586bb31d02": async () => {
		const m = await import("./assets/BusinessLeadForm-CAMOc-m4.js");
		return { get "BusinessLeadForm"() {
			return m["BusinessLeadForm"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-CpgkKxO2.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"e34f08728615": async () => {
		const m = await import("./assets/SubscribeForm-C7GcaamL.js");
		return { get "SubscribeForm"() {
			return m["SubscribeForm"];
		} };
	},
	"e79dbcec6d65": async () => {
		const m = await import("./assets/EditorialHome-BxVcTC8d.js");
		return { get "EditorialHome"() {
			return m["EditorialHome"];
		} };
	},
	"ed2eca688c2b": async () => {
		const m = await import("./assets/ConfigurationCalculator-CzuQ7dsx.js");
		return { get "ConfigurationCalculator"() {
			return m["ConfigurationCalculator"];
		} };
	},
	"ff4beb716954": async () => {
		const m = await import("./assets/VpnPilotForm-CPVlqIYm.js");
		return { get "VpnPilotForm"() {
			return m["VpnPilotForm"];
		} };
	}
};
//#endregion
